---
title: Freelance Jobs - Scam?
date: 2022/9/16
description: Lets talk real about this.
...
# Get commit count by email, Also: Below entries are sorted alphabetically.
sort names_and_emails.txt | uniq -c | sort
# Output:
#  100 FirstName1 LastName abc1@def.com
#   12 FirstName2 LastName abc2@def.com
#   50 FirstName3 LastName abc3@def.com

# Get unique account details (name and email)
sort names_and_emails.txt | uniq
# Output:
# FirstName LastName abc1@def.com
# FirstName LastName abc2@def.com
# FirstName LastName abc3@def.com
